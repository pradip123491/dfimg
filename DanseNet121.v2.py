# DenseNet121 using timm with CHUNK-wise loading
import os
import cv2
import torch
import numpy as np
...
EPOCHS = 20
LEARNING_RATE = 5e-5
CHECKPOINT_DIR = '/home/shavak/YC/project/models/checkpoints_densenet121_v2.0'
...
# 🧠 Load DenseNet121
# ──────────────────────────────────────────────────
model = create_model('densenet121', pretrained=True, num_classes=1)
    ...
    for epoch in range(start_epoch, EPOCHS):
        try:
            ...
            torch.save({
                ...
                'val_acc': val_acc
            }, os.path.join(CHECKPOINT_DIR, f'densenet_epoch_{epoch + 1}_v1.0.pth'))
            ...
            if val_acc > best_val_acc:
                ...
                torch.save({
                    ...
                    'optimizer_state': optimizer.state_dict(),
                    'val_acc': val_acc
                }, os.path.join(CHECKPOINT_DIR, 'best_densenet121_v1.0.pth'))
            else:
                trigger_times += 1
